...
{
    /// <summary>
    /// Class <c>AuthorController</c> perform the role of the controller. This controller is used to perform
    /// the CRUD operation on the the Author table in the database. 
    /// </summary>
    ...
    public class AuthorController : Controller
    {
        ...
        /// <summary>
        /// Method <c>Delete</c> returns a view comtaining a list of all available authors after deleting 
